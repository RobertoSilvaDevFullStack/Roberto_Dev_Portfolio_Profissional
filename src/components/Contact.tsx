...
const contactInfo = [
  ...
  },
  {
    ...
    label: "GitHub",
    value: "github.com/meu_usuario",
    href: "https://github.com/meu_usuario",
    color: "text-slate-400"
  },
  {
    icon: <Linkedin className="w-6 h-6" />,
    label: "LinkedIn",
    value: "linkedin.com/in/meu-perfil",
    href: "https://linkedin.com/in/meu-perfil",
    color: "text-blue-500"
  },
  {
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 slide-in-up">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              ...
              Entre em contato para discutirmos como posso contribuir para o seu próximo projeto.
            </p>
          </div>
                ...
                >
                  <CardContent className="p-6">
                    {contact.href ? (
                      ...
                      >
                        <div className={`${contact.color} group-hover:text-primary transition-colors p-2 bg-primary/10 rounded-lg`}>
                          {contact.icon}
                        </div>
                        <div>
                      ...
                      <div className="flex items-center gap-4">
                        <div className={`${contact.color} p-2 bg-primary/10 rounded-lg`}>
                          {contact.icon}
                        </div>
                        <div>
            ...
            <div className="flex flex-col justify-center space-y-8 animate-slide-in-right">
              ...
              <div className="bg-glass border-glass backdrop-blur-glass rounded-lg p-6 text-center">
                <div className="flex items-center justify-center gap-3 mb-3">
                  ...
                  <span className="text-green-400 font-semibold">Disponível para projetos</span>
                </div>
